...
// The nested function can access the internal variable for the osle reason of the calling is still inside the scope 
// of myFunction, or the parent function.
...
lowerCaseNames(zooAnimals);
  ...
  */
  ...
  function USApop(zooAnimals) {
    const animalPop = zooAnimals.reduce((total, state) => {
